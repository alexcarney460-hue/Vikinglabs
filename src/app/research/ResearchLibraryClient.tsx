...
import type { ResearchItem } from '@/lib/research/items';
...
export default function ResearchLibraryClient({ initialItems }: { initialItems: ResearchItem[] }) {
  ...
  }, [query, savedOnly, savedIds, initialItems]);
