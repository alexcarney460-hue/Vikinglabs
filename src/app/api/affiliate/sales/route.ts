 ...
 * Get sales stats: orders, revenue, commission, payouts.
...
export async function GET(request: NextRequest) {
  try {
    ...
    const commissionCents = Math.round(stat.revenueCents * commissionRate);
    ...
    return NextResponse.json({
      ...
      data: {
        ...
        payoutStatus: 'pending', // TODO: Track payout status in database
        payoutMinimum: 5000, // $50 minimum (in cents)
      },
    });
  } catch (error) {
